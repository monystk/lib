...
# (le @ ne compte pas pour 1 caractère)

def handleNumberFive (list)
    number=0
    list.each do|i|
        if i.slice!(0)=="@" #slice! va supprimer les @
    ...
    puts"Nombre de Handles de 5 caractères => #{number}
    puts "\n"
 end
